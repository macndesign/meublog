...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_post', (
            ...
            ('sub_titulo', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('data_publicacao', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('data_alteracao', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
    ...
    models = {
        ...
        u'core.post': {
            ...
            'data_alteracao': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
